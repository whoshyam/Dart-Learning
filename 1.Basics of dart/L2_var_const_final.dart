void main(){
  ...
  var variable1='10';//var automatically identifies the value and put it into the data type type more like dynamic
  final variable2='10';//The final variable 'variable2' can only be set once.
  const variable3='10';//Constant variables can't be assigned a value.
